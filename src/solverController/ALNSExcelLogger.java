...
/**
 * This class allows to log the output of the ALNS algorithm to an Excel (XLSX) file.
 * @author Frash
 */
public class ALNSExcelLogger {
    ...
    private final static String [] HEADERS = {
        ...
        "Updated Cluster Roulette","Cluster Roulette avg. p",
        "Comment"
    };
...
//        dataCellStyle.setFont(normalFont);
    ...
    /**
     * Closes the FileOutputStream gracefully by making sure every buffered write
